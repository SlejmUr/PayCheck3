...
public class DLCs
{
    ...
    public static bool GETdlcentitlements(HttpRequest _, ServerStruct serverStruct)
    {
        TopLevel<DLC_Value> dlc = new()
        {
            ...
            {
                Data = new(),
                DlcType = "PSN" // WHY NOT REQUEST YOUR OWN DLC TYPE STARBREEZE ??
            }
        };
        dlc.Value.Data = JsonConvert.DeserializeObject<Dictionary<string, string[]>>(File.ReadAllText("Files/DLC_Entiltements.json"))!;
